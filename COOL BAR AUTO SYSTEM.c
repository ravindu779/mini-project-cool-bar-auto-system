...
int main()
{
    int ch,qty,i,amount,net=0,blance;

    start:
    printf("\t\t\t\t\t|||>>>STAR COOL BAAR<<<|||");
    printf("\n\n\t\t\t\t\tWELLCOME TO MENU CARD");
    ...
    printf("\n\t\t\t\t5.REDBULL 250ml                   Rs:300");
    printf("\n\t\t\t\t5.FANTA ORANGE CAN 330ml          Rs:250");
    printf("\n\t\t\t\t5.PEPSI CAN 330ml                 Rs:350");
    printf("\n\t\t\t\t5.SPRITE CAN 320ml                Rs:250");
    printf("\n\n Enter Your choice  : ");
    scanf("%d",&ch);
    switch(ch)
    {
